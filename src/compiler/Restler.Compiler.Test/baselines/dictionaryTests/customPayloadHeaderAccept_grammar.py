...
request = requests.Request([
    ...
    primitives.restler_static_string("Host: localhost:8888\r\n"),
    primitives.restler_static_string("Accept: "),
    primitives.restler_custom_payload_header("/stores/{storeId}/order/post/Accept"),
    primitives.restler_static_string("\r\n"),
    primitives.restler_static_string("Content-Type: "),
...
request = requests.Request([
    ...
    primitives.restler_static_string("\r\n"),
    primitives.restler_static_string("Accept: "),
    primitives.restler_custom_payload("/stores/{storeId}/order2/post/Accept", quoted=False),
    primitives.restler_static_string("\r\n"),
    primitives.restler_static_string("Content-Type: "),
...
request = requests.Request([
    ...
    primitives.restler_static_string("\r\n"),
    primitives.restler_static_string("Accept: "),
    primitives.restler_custom_payload_header("/stores/{storeId}/order3/post/Accept"),
    primitives.restler_static_string("\r\n"),
    primitives.restler_static_string("Content-Type: "),
